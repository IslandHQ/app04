      ...
      <form onSubmit={handleSave} className="glass-panel" style={{ padding: '1.5rem' }}>
        ...
        <div style={{ marginBottom: '2rem' }}>
          <label style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontWeight: 600, marginBottom: '0.5rem', cursor: 'pointer' }}>
            ...
            />
            Reasoning（セルフチェック）を有効にする
          </label>
          <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)', marginTop: '0.25rem', marginLeft: '1.6rem' }}>
            生成前後にAIに自己検閲を行わせることで、問題の質を向上させます。（生成速度が低下する場合があります）
          </p>
        </div>
